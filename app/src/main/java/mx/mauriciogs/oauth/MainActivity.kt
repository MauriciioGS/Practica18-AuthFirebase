...
class MainActivity : AppCompatActivity() {
    ...
    private fun sesiones() {
        val preferencias =
            getSharedPreferences(getString(R.string.file_preferencia), MODE_PRIVATE)
    ...
    private fun alert() {
        ...
        bulder.setMessage("Se produjo un error, contacte al provedor")
    ...
    override fun onStart() {
        super.onStart()
        binding.layoutAcceso.visibility = VISIBLE
    }
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                if (result.resultCode == RESULT_OK) {
                    ...
                    try {
                        ...
                        Toast.makeText(this, "Sign in successful", LENGTH_SHORT).show()
                        if (account != null) {
                            val credenciales =
                        ...
                        Toast.makeText(this, "Sign in failed: " + e.statusCode, LENGTH_SHORT)
                            .show()
                    }
                }
            }
